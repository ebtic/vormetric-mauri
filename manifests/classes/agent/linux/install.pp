class vormetric_mauri::agent::linux::install() {
  ...
  $vm_management_folder = "/btconfigtestM"
  $agent_download_url = "10.255.92.77"
  #$agent_download_url = "ec2-54-161-187-162.compute-1.amazonaws.com"
  $vm_dns = "$::appstack_server_identifier.$::domain"
  
  #for testing purpose
  notify {"vormetric_mauri_vm_state ${vormetric_mauri::params::vm_state}, vormetric_mauri_vm_dns: ${vm_dns}, vormetric_mauri_guardpoint_list: ${vormetric_mauri::params::guardpoint_list}, vormetric_mauri_account_state: ${vormetric_mauri::params::account_state}":}
